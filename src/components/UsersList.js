        ...
        {users.map((u) => {
          ...
          return (
            <tr key={u.id}>
              <td>{u.username}</td>
              <td>{roles.join(", ")}</td>
              <td className={classes.center}>{u.ordersCount}</td>
              <td className={classes.center}>
                {u.hasActiveOrder ? "Yes" : "No"}
              </td>
              <td className={classes.center}>{u.reviewsCount}</td>
              <td className={classes.center}>{u.member ? "Yes" : "No"}</td>
              <td className={classes.center}>{u.banned ? "🔒" : "—"}</td>
              <td className={classes.center}>
                {!u.banned ? (
